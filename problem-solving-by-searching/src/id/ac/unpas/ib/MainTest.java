...
public class MainTest {
    public static void main(String[] args) {
        Node banten = new Node("Banten");
        Node rangkasbitung = new Node("Rangkasbitung");
        ...
        banten.addTetangga(rangkasbitung);
        banten.addTetangga(pandeglang);

        rangkasbitung.addTetangga(pandeglang);
        rangkasbitung.addTetangga(banten);
        ...
        bfs.search(banten, semarang);
        System.out.println();

        System.out.println("DLS");
        DepthLimitedSearch dls = new DepthLimitedSearch();
        dls.setLimit(10);
        dls.search(banten, semarang);
        System.out.println();

        NodeUCS bantenUCS = new NodeUCS(banten, 366);
        NodeUCS rangkasbitungUCS = new NodeUCS(Rangkasbitung, 0);
        ...
        bantenUCS.addTetangga(rangkasbitungUCS);
        bantenUCS.addTetangga(pandeglangUCS);

        rangkasbitungUCS.addTetangga(pandeglangUCS);
        rangkasbitungUCS.addTetangga(bantenUCS);
        ...
        ucs.search(bantenUCS, semarangUCS);
        System.out.println();
    }
}
